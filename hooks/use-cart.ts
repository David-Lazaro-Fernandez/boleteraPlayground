...
export function useCart() {
  ...
  const addItem = useCallback((item: CartItem) => {
    setItems(currentItems => {
      ...
      const existingItemIndex = currentItems.findIndex(existingItem => existingItem.id === item.id)
  ...
  const loadFromExistingData = useCallback((selectedSeats: any[], generalTickets: any[]) => {
