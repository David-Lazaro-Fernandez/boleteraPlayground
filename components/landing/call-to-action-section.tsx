    ...
    <section className="py-16 bg-gradient-to-r from-gradient-start to-gradient-end">
      <div className="container mx-auto px-6 lg:px-8 max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div className="relative">
            <div className="w-full max-w-md mx-auto">
              <svg viewBox="0 0 400 300" className="w-full h-auto">
                <rect x="50" y="100" width="300" height="150" rx="20" fill="#23265D" />
          ...
          <div>
            <h2 className="text-3xl font-bold text-text-light mb-4">Agenda tu evento con nosotros</h2>
            ...
            <Button className="bg-primary-button hover:bg-primary-button/90 text-white px-8 py-3 text-lg">Agenda Ahora</Button>
          </div>
        </div>
      </div>
    </section>
